...
public class BuiltInDataController {
    ...
    public String dataSubmit() {
        ...
        AppUser user2 = new AppUser("Naim Jalil", "naim@mail", "naim", "1", "No. 8, Jalan Japun", "0136547521", Role.PHARMACIST);
        appUserService.registerCustomer(user1);
        appUserService.registerPharmacist(user2);
        ...
        // Create stocks
        Stock stock1 = new Stock(product1, supplier1, user2, 50);
        Stock stock2 = new Stock(product2, supplier1, user2, 50);
        Stock stock3 = new Stock(product3, supplier2, user2, 50);
